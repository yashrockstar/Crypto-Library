 ...
 * with OAEP SHA-256 and no padding.
 */
public class RSA_OAEP_SHA256_NoPadding_CryptographicAlgorithm implements CryptographicAlgorithm {

	PrivateKeyFormat privateKeyFormat;
	PublicKeyFormat publicKeyFormat;

	/**
	 * Constructor for RSA_OAEP_SHA256_NoPadding_CryptographicAlgorithm.
	 *
	 * @param <privateKeyFormat> The format of the private key.
	 * @param <publicKeyFormat>  The format of the public key.
	 */
	public RSA_OAEP_SHA256_NoPadding_CryptographicAlgorithm(PrivateKeyFormat privateKeyFormat,
			PublicKeyFormat publicKeyFormat) {
	...
	/**
	 * Encrypts the provided data using RSA with OAEP SHA-256 and no padding.
	 *
	...
	public EncryptedPayload encrypt(String key) throws Exception {
		...
		// Encrypt the data using RSA with OAEP SHA-256 and no padding
		byte[] encrypt = EncryptionHelper.encrypt(key.getBytes(), x509Key,
				RSAModePadding.OAEP_SHA256_NoPadding.getAlgorithm());
	...
	public DecryptedPayload decrypt(String data) throws Exception {
		...
		// Decrypt the data using RSA with OAEP SHA-256 and no padding
